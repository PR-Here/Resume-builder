...
export default function ClassicTemplate({ resumeData, previewMode = false, fontSize = 16 }: ClassicTemplateProps) {
      ...
      {resumeData.projects.map((project: Project) => {
        ...
        return (
          <View key={project.id} style={styles.item}>
            ...
            <Text><Text style={styles.boldLabel}>Description: </Text><Text style={[styles.text, { fontSize: fontSize - 2 }]}>{project.description}</Text></Text>
            <Text style={[styles.techSection, styles.boldLabel]}>Technologies:</Text>
            <View style={styles.skillListRow}>
              <View style={styles.skillCol}>
            ...
            <Text><Text style={styles.boldLabel}>App Link: </Text><Text style={[styles.text, { fontSize: fontSize - 2 }]}>{project.link}</Text></Text>
          </View>
        );
      })}
